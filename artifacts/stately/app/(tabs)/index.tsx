      ...
      {latest ? (
        <>
          <View style={styles.scoreSection}>
            <ScoreCard
              score={latest.condition.score}
              label={latest.condition.label}
            />
          ...
          <View style={styles.metricsRow}>
            <MetricCard
              title="Activity"
              score={latest.activity.score}
              subtitle={`${latest.activity.activeKcal} kcal`}
              icon="zap"
            />
            <MetricCard
              title="Sleep"
              score={latest.sleep.score}
              subtitle={`${latest.sleep.hours}h sleep`}
              icon="moon"
            />
            <MetricCard
              title="HRV"
              score={latest.hrv.score}
              subtitle={`${latest.hrv.value} ms`}
              icon="heart"
            />
          </View>
